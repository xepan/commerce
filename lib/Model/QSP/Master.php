...
class Model_QSP_Master extends \xepan\hr\Model_Document{
	...
	function generatePDF($action ='return'){
		...
		$view = $this->owner->add('xepan\commerce\View_QSP',['qsp_model'=>$this, 'master_template'=>'view/print-prime-documents/master-'.strtolower($this['type']),'detail_template'=>'view/print-prime-documents/print-detail']);
