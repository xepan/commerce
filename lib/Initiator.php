...
class Initiator extends \Controller_Addon {
    ...
    function collect_shortcuts($app,&$shortcuts){
		...
		$shortcuts[]=["title"=>"Shipping Configuration","keywords"=>"product shipping configuration shipping rates configuration","description"=>"Product/Item Shipping Configuration","normal_access"=>"Commerce -> Shipping Configuration","url"=>$this->app->url('xepan_commerce_shippingrule'),'mode'=>'frame'];
		$shortcuts[]=["title"=>"Round Amount Standard Configuration","keywords"=>"amount standard formate amount up formate amount down formate","description"=>"Manage Round Amount Formate For Sales Order, Purchase Order, Sales Invoice, Purchase Invoice, Quotation","normal_access"=>"Commerce -> Round Amount Configuration","url"=>$this->app->url('xepan_commerce_amountstandard'),'mode'=>'frame'];
	}
