...
class Initiator extends \Controller_Addon {
    ...
    function collect_shortcuts($app,&$shortcuts){
		...
		$shortcuts[]=["title"=>"Taxation Configuration","keywords"=>"tax subtax management taxation rule","description"=>"Taxation Management Define All Type Of Taxes","normal_access"=>"Commerce -> Taxation Configuration","url"=>$this->app->url('xepan_commerce_tax'),'mode'=>'frame'];
		$shortcuts[]=["title"=>"Custom Field Configuration","keywords"=>"item product custom field","description"=>"Product Specific Customer Options","normal_access"=>"Commerce -> Custom Fields","url"=>$this->app->url('xepan_commerce_customfield'),'mode'=>'frame'];
		$shortcuts[]=["title"=>"Specification Configuration","keywords"=>"Specification product item properties attributes","description"=>"Product Item Attributes & Specification","normal_access"=>"Commerce -> Specification Configuration","url"=>$this->app->url('xepan_commerce_specification'),'mode'=>'frame'];
		$shortcuts[]=["title"=>"Payment Gateway Configuration","keywords"=>"third party payment gateway integration online payment gateway","description"=>"Management Of Third Party Payment Gateway API's","normal_access"=>"Commerce -> Payment Gateway","url"=>$this->app->url('xepan_commerce_paymentgateway'),'mode'=>'frame'];
		...
		$shortcuts[]=["title"=>"Quotation Layout","keywords"=>"quotation formate design print layout","description"=>"Customise Quotation layout","normal_access"=>"Commerce -> Layouts Configuration / Quotation","url"=>$this->app->url('xepan_commerce_layouts',['cut_object'=>'admin_layout_cube_layouts_tabs_quotation']),'mode'=>'frame'];
		$shortcuts[]=["title"=>"Sales Order Layout","keywords"=>"sales order salesorder so formate design print layout","description"=>"Customise Sales Order layout","normal_access"=>"Commerce -> Layouts Configuration / Sales Order","url"=>$this->app->url('xepan_commerce_layouts',['cut_object'=>'admin_layout_cube_layouts_tabs_sales_order']),'mode'=>'frame'];
		$shortcuts[]=["title"=>"Sales Invoice Layout","keywords"=>"sales invoice salesinvoice si formate design print layout","description"=>"Customise Sales Invoice layout","normal_access"=>"Commerce -> Layouts Configuration / Sales Invoice","url"=>$this->app->url('xepan_commerce_layouts',['cut_object'=>'admin_layout_cube_layouts_tabs_sales_invoice']),'mode'=>'frame'];
		$shortcuts[]=["title"=>"Purchase Order Layout","keywords"=>"purhcase order purchaseorder po formate design print layout","description"=>"Customise Purchase Order layout","normal_access"=>"Commerce -> Layouts Configuration / Purchase Order","url"=>$this->app->url('xepan_commerce_layouts',['cut_object'=>'admin_layout_cube_layouts_tabs_po']),'mode'=>'frame'];
		$shortcuts[]=["title"=>"Purchase Invoice Layout","keywords"=>"purhcase invoice purchaseinvoice pi formate design print layout","description"=>"Customise Purchase Invoice layout","normal_access"=>"Commerce -> Layouts Configuration / Purchase Invoice","url"=>$this->app->url('xepan_commerce_layouts',['cut_object'=>'admin_layout_cube_layouts_tabs_pi']),'mode'=>'frame'];
		$shortcuts[]=["title"=>"Challan Layout","keywords"=>"challan billty formate design print layout","description"=>"Customise Challan layout","normal_access"=>"Commerce -> Layouts Configuration / Challan","url"=>$this->app->url('xepan_commerce_layouts',['cut_object'=>'admin_layout_cube_layouts_tabs_challan']),'mode'=>'frame'];
		
		$shortcuts[]=["title"=>"Designer Library Configuration","keywords"=>"designer image library front designer tool printing designer tool image library","description"=>"Predefine Image Library For Frontend Printing Designer Tool","normal_access"=>"Commerce -> Designer Tool Library Configuration","url"=>$this->app->url('xepan_commerce_designerlibraryimages'),'mode'=>'frame'];
		$shortcuts[]=["title"=>"Fonts Configuration","keywords"=>"designer font list printing font list configuration google font intergration custom font .ttf integration","description"=>"Google Font And Custom Font Family Configuration","normal_access"=>"Commerce -> Font Family Configuration","url"=>$this->app->url('xepan_commerce_font'),'mode'=>'frame'];
		$shortcuts[]=["title"=>"Terms & Conditions Configuration","keywords"=>"company terms & condition custom T&C","description"=>"Define Terms & Conditions For Sales Order, Sales Invoice, Purchase Order, Purchase Invoice, Quotation","normal_access"=>"Commerce -> Terms & Conditions Configuration","url"=>$this->app->url('xepan_commerce_tnc'),'mode'=>'frame'];
