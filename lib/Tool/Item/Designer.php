...
class Tool_Item_Designer extends \View{
	...
	function render(){
		...
		$this->js(true)
				...
				;
		$this->js(true)
				->_library('WebFont')->load(['google'=>['families'=>[ 'Abel', 'Abril Fatface', 'Aclonica', 'Acme', 'Actor', 'Cabin','Cambay','Cambo','Candal','Petit Formal Script', 'Petrona', 'Philosopher','Piedra', 'Ubuntu']]]);
