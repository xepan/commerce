...
class page_invoicepurchase extends \Page {
	...
	function init(){
		...
		$pinvoice_no = $this->add('xepan\base\View_Document',['action'=>$action],'basic_info',['page/order/purchase/invoice','basic_info']);
		$pinvoice_no->setModel($porder,['name'],['name']);

		$pinvoice_item = $this->add('xepan\base\View_Document',['action'=>$action],'item_info',['page/order/purchase/invoice','item_info']);
	...
	function defaultTemplate(){
		return ['page/order/purchase/invoice'];
	}
}
