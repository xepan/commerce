...
class page_store_reports_itemstock extends \xepan\commerce\page_store_reports_storereportsidebar{
	...
	function init(){
		...
		$grid->setModel($opening_model,['name','opening','purchase','purchase_return','consumed','consumption_booked','received','adjustment_add','adjustment_removed','issue','issue_submitted','sales_return','movement_in','movement_out','net_stock']);
