...
class page_designer_itemimages extends Page {
  ...
  function page_image_library(){
      ...
      //Category Crud and It's Model
      $cat_crud = $cat_col->add('CRUD',array('entity_name'=>'Category','allow_edit'=>false,'allow_del'=>false,'allow_add'=>false));
      $cat_crud->frame_options = ['width'=>'500'];
      ...
      // //Member Image Crud
      $crud = $image_col->add('CRUD',array('entity_name'=>'Image','allow_del'=>false,'allow_add'=>false,'allow_edit'=>false,'grid_class'=>'xGrid','grid_options'=>array('grid_template'=>'view/xShop-DesignerItemImages','grid_template_path'=>'epan-components/xShop')));
      $crud->frame_options = ['width'=>'500'];
