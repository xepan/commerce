 ...
 class page_itemdetail extends \xepan\base\Page {
	...
	function page_index(){
		...
		$basic_item->setModel($item,['name','sku','display_sequence','status','expiry_date',
								...
								'description','terms_and_conditions','is_designable','upload_file_label','item_specific_upload_hint','upload_file_group','is_renewable','remind_to','renewable_value','renewable_unit','to_customer_id','is_teller_made_item','minimum_stock_limit','is_serializable', 'is_package','hsn_sac','slug_url'],
		...
		*/	
			...
			$crud_serialize->setModel($serial_model,['serial_no','is_available','is_return','narration','purchase_order_id','purchase_invoice_id','sale_order_id','sale_invoice_id','dispatch_id','transaction_row_id']);
