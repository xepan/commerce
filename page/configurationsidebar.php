...
class page_configurationsidebar extends \xepan\base\Page{
	function init(){
		...
		$this->app->side_menu->addItem(['Fonts','icon'=>'fa fa-font'],'xepan_commerce_font')->setAttr(['title'=>'Fonts']);
		...
		$this->app->side_menu->addItem(['Store Config','icon'=>'fa fa-building'],'xepan_commerce_storeconfig')->setAttr(['title'=>'Stock/Store Configuration']);
